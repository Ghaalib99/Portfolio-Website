...
const About = () => {
  return (
    <div id='about' className='my-3 p-7 body-content'>
        ...
        <div className='flex text-justify justify-between block-p'>
            <p className='mr-7 block' data-aos="fade-right" data-aos-delay="50"
        ...
        data-aos-easing="ease-in-out-cubic">I am experienced in building very light and fast web applications. I make sure tasks are perfected on time while still delivering the best quality. I also develop web contents to suit your taste or even better.</p>
            ...
            <div className="flex flex-col block block-p" data-aos="fade-left" data-aos-delay="50"
        data-aos-duration="2000"
        data-aos-easing="ease-in-out-cubic">
                ...
                <div className='flex flex-wrap block-p'>
