...
const Skills = () => {
  return (
    <div id='skills' className='bg-blue-50 mt-3 p-7 body-content'>
        <h1 className='text-3xl mb-4 py-2 font-bold border-b-4 border-sky-600'>Skills</h1>
        <div className='' data-aos="fade-up" data-aos-delay="50"  data-aos-duration="2000"   data-aos-easing="ease-in-out-cubic">
